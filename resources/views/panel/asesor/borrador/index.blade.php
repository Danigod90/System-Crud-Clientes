...
<div class="px-2 py-2">
    <div style="max-width:860px; margin:0 auto;">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px;">
            ...
            <a href="{{ route('asesor.borrador.create') }}"
        ...
        <div style="background:#fff; border-radius:12px; border:1px solid #e5e7eb; padding:16px 20px; margin-bottom:10px; box-shadow:0 1px 4px rgba(0,0,0,0.04); display:flex; justify-content:space-between; align-items:center;">
            <div>
                <div style="display:flex; align-items:center; gap:8px; margin-bottom:4px;">
                    <span style="font-size:14px; font-weight:600; color:#1e293b;">{{ $borrador->nombre_organizacion }}</span>
                    @if($borrador->estado === 'enviado')
                    ...
                    @elseif($borrador->estado === 'archivado')
                ...
                <p style="font-size:12px; color:#94a3b8; margin:0;">
                    ...
                    · {{ $borrador->tareas->count() ?? 0 }} tarea(s)
                </p>
            </div>
            <a href="{{ route('asesor.borrador.show', $borrador->id) }}"
