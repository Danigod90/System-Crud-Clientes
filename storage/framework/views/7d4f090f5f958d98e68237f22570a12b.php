...
<?php endif; ?>
    ...
    style="display:flex; align-items:center; gap:10px; padding:9px 14px; margin:1px 8px; border-radius:8px; font-size:13px; color:<?php echo e(request()->routeIs('asesor.borrador.*') ? '#fff' : 'rgba(255,255,255,0.55)'); ?>; background:<?php echo e(request()->routeIs('asesor.borrador.*') ? 'rgba(244,114,182,0.2)' : 'transparent'); ?>; text-decoration:none; border:<?php echo e(request()->routeIs('asesor.borrador.*') ? '1px solid rgba(244,114,182,0.3)' : '1px solid transparent'); ?>; transition:all 0.2s;"
    onmouseover="this.style.background='rgba(255,255,255,0.12)'"
    onmouseout="this.style.background='<?php echo e(request()->routeIs('asesor.borrador.*') ? 'rgba(244,114,182,0.2)' : 'transparent'); ?>'">
