...
<div style="margin-bottom:20px;">
...
]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$field, $label, $hasFormato, $default, $sinVal, $sinLabel, $defaultFormato]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    value="<?php echo e(old($field, $default)); ?>"
    style="...">
<?php if($hasFormato): ?>
<select name="<?php echo e($field); ?>_formato" style="...">
    <option value="">Formato...</option>
    <option value="impreso" <?php echo e(old("{$field}_formato", $defaultFormato) == 'impreso' ? 'selected' : ''); ?>>Impreso</option>
    <option value="digital" <?php echo e(old("{$field}_formato", $defaultFormato) == 'digital' ? 'selected' : ''); ?>>Digital</option>
    <?php if($sinVal): ?>
    <option value="<?php echo e($sinVal); ?>" <?php echo e(old("{$field}_formato", $defaultFormato) == $sinVal ? 'selected' : ''); ?>><?php echo e($sinLabel); ?></option>
    <?php endif; ?>
</select>
<?php endif; ?>
        </div>
