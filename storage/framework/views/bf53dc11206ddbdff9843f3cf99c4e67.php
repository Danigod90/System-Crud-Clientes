...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="tipo_organizacion"
                            ...
                            <?php $__currentLoopData = ['Club','Universidad','Cooperativa','Escuela y Colegio','Asentamiento','Comision Vecinal','Juntas']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tipo); ?>" <?php echo e(old('tipo_organizacion') == $tipo ? 'selected' : ''); ?>><?php echo e($tipo); ?></option>
