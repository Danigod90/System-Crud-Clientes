...
<?php $component = App\View\Components\PanelLayout::resolve(['title' => 'Mis Organizaciones'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
