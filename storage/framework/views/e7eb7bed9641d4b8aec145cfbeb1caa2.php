...
<div style="max-width:1000px; margin:0 auto; padding:8px 0;">
    ...
    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:14px; margin-bottom:20px;">
        ...
        <div class="card-stat" style="background:linear-gradient(135deg,#7C6FC4,#D088C0); border-radius:14px; padding:18px 20px; position:relative; overflow:hidden; box-shadow:0 4px 12px rgba(124,111,196,0.35);">
            ...
            <div style="font-size:36px; font-weight:700; color:#fff; line-height:1;"><?php echo e($stats['entradas_mes']); ?></div>
            <span style="display:inline-flex; background:rgba(255,255,255,0.22); border-radius:20px; padding:3px 10px; font-size:10px; color:#fff; margin-top:10px;"><?php echo e(now()->translatedFormat('F Y')); ?></span>
        </div>
        ...
        <div class="card-stat" style="background:linear-gradient(135deg,#F09060,#F0C040); border-radius:14px; padding:18px 20px; position:relative; overflow:hidden; box-shadow:0 4px 12px rgba(240,144,96,0.35);">
            ...
            <div style="font-size:36px; font-weight:700; color:#fff; line-height:1;"><?php echo e($stats['log_pendientes']); ?></div>
        ...
        <div class="card-stat" style="background:linear-gradient(135deg,#4ABFB0,#60A8E0); border-radius:14px; padding:18px 20px; position:relative; overflow:hidden; box-shadow:0 4px 12px rgba(74,191,176,0.35);">
            ...
            <div style="font-size:36px; font-weight:700; color:#fff; line-height:1;"><?php echo e($stats['log_devueltos']); ?></div>
    ...
    <div style="background:#fff; border-radius:12px; border:1px solid #e5e7eb; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,0.04); margin-bottom:14px;">
        <div style="padding:12px 16px; border-bottom:1px solid #f3f4f6; display:flex; justify-content:space-between; align-items:center;">
            ...
            <a href="<?php echo e(route('secretaria.con-nota.index')); ?>" style="font-size:12px; color:#2563eb; text-decoration:none;">Ver todos →</a>
        </div>
            ...
            <tbody>
                <?php
                    $logPendientes = \App\Models\EntradaConNota::where('asunto_log', true)
                        ...
                        ->latest()->take(5)->get();
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $logPendientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom:1px solid #f3f4f6;">
                    <td style="padding:10px 16px; color:#185FA5; font-weight:600; font-family:monospace;"><?php echo e($entrada->codigo_org); ?></td>
                    <td style="padding:10px 16px; color:#1e293b;"><?php echo e($entrada->nombre_organizacion); ?></td>
                    <td style="padding:10px 16px; color:#374151;"><?php echo e($entrada->log_urnas); ?></td>
                    <td style="padding:10px 16px; color:#374151;"><?php echo e($entrada->log_cuartos); ?></td>
                    <td style="padding:10px 16px; color:#374151;"><?php echo e($entrada->log_tintas); ?></td>
                    <td style="padding:10px 16px;">
                        <a href="<?php echo e(route('secretaria.con-nota.show', $entrada->id)); ?>"
    ...
    <div style="background:#fff; border-radius:12px; border:1px solid #e5e7eb; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,0.04);">
        <div style="padding:12px 16px; border-bottom:1px solid #f3f4f6; display:flex; justify-content:space-between; align-items:center;">
            ...
            <a href="<?php echo e(route('secretaria.sin-nota.index')); ?>" style="font-size:12px; color:#2563eb; text-decoration:none;">Ver todas →</a>
        </div>
        <table style="width:100%; border-collapse:collapse; font-size:12px;">
            <thead>
                <tr style="background:#f8fafc;">
            ...
            <tbody>
                ...
                ?>
                <?php $__empty_1 = true; $__currentLoopData = $ultimasEntradas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entrada): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr style="border-bottom:1px solid #f3f4f6;">
                    <td style="padding:10px 16px; color:#6b7280; font-weight:600; font-family:monospace;"><?php echo e($entrada->numero_entrada); ?></td>
                    <td style="padding:10px 16px; color:#1e293b; font-weight:500;"><?php echo e($entrada->nombre); ?></td>
                    <td style="padding:10px 16px; color:#374151;"><?php echo e($entrada->apellido); ?></td>
                    <td style="padding:10px 16px; color:#374151;"><?php echo e($entrada->asesor ? $entrada->asesor->nombre . ' ' . $entrada->asesor->apellido : '—'); ?></td>
                    <td style="padding:10px 16px; color:#94a3b8;"><?php echo e($entrada->created_at->format('d/m/Y')); ?></td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/panel/dashboard-sin-nota.blade.php ENDPATH**/ ?>