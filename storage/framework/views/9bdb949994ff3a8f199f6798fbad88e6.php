...
<div class="card-stat" style="background:linear-gradient(135deg,#4ABFB0,#60A8E0); border-radius:14px; padding:18px 20px; position:relative; overflow:visible; box-shadow:0 4px 12px rgba(74,191,176,0.35);">
    ...
    <div style="font-size:36px; font-weight:700; color:#fff; line-height:1;"><?php echo e($stats['obs_pendientes']); ?></div>
    <span style="display:inline-flex; background:rgba(255,255,255,0.22); border-radius:20px; padding:3px 10px; font-size:10px; color:#fff; margin-top:10px;">sin realizar</span>
        ...
        <div class="card-stat" style="background:linear-gradient(135deg,#5BC8E8,#A090E0); border-radius:14px; padding:18px 20px; position:relative; overflow:visible; box-shadow:0 4px 12px rgba(91,200,232,0.35);">
            ...
            <div style="font-size:36px; font-weight:700; color:#fff; line-height:1;"><?php echo e($stats['elecciones_proximas']); ?></div>
...
<div style="background:rgba(255,255,255,0.95); border-radius:10px 10px 0 0; border:1px solid rgba(255,255,255,0.9); border-bottom:none;">
    <div style="padding:4px 12px; border-bottom:1px solid #e5e7eb; display:flex; justify-content:space-between; align-items:center;">
        ...
        <div style="display:flex; align-items:center; gap:6px;">
            <form method="GET" action="<?php echo e(route('panel.dashboard')); ?>" style="display:flex; align-items:center; gap:4px;">
               <select name="asesor" onchange="this.form.submit()" style="border:1px solid #e5e7eb; border-radius:6px; padding:2px 6px; font-size:10px; color:#374151; outline:none; background:#fff; cursor:pointer;">
                ...
                <?php if(request('asesor')): ?>
                    <a href="<?php echo e(route('panel.dashboard')); ?>" style="font-size:10px; color:#6b7280; text-decoration:none;">✕</a>
                <?php endif; ?>
            </form>
            <a href="<?php echo e(route('secretaria.con-nota.index')); ?>" style="font-size:10px; color:#185FA5; text-decoration:none;">Ver todas</a>
        </div>
    </div>
    ...
    <table style="width:100%; border-collapse:collapse; font-size:11px;">
        <tbody>
            ...
            <tr style="border-bottom:1px solid #f3f4f6;" onmouseover="this.style.background='rgba(100,100,180,0.06)'" onmouseout="this.style.background='transparent'">
                <td style="padding:5px 10px; color:#185FA5; font-weight:600; font-family:monospace; width:120px;"><?php echo e($entrada->codigo_org); ?></td>
                <td style="padding:5px 10px; color:#111827;"><?php echo e($entrada->nombre_organizacion); ?></td>
                <td style="padding:5px 10px; color:#6b7280; width:120px; font-size:11.5px;"><?php echo e($entrada->asesor_asignado ?? '-'); ?></td>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/panel/dashboard.blade.php ENDPATH**/ ?>