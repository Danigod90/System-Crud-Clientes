...
<?php $component = App\View\Components\PanelLayout::resolve(['title' => 'Organizaciones Técnica'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div style="width:100%;">
        ...
        <div class="bg-white shadow-sm sm:rounded-lg p-6">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
                ...
                <a href="<?php echo e(route('tecnico.dashboard')); ?>"
            ...
            <form method="GET" action="<?php echo e(route('tecnico.organizaciones')); ?>" style="margin-bottom:20px;">
                    ...
                    <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:12px; margin-bottom:14px;">
                        ...
                        <div>
                            ...
                            <select name="estado" style="width:100%; border:1px solid #e5e7eb; border-radius:8px; padding:7px 10px; font-size:13px; color:#374151; outline:none; background:#fff;">
                                ...
                                <option value="enviado" <?php echo e(request('estado') == 'enviado' ? 'selected' : ''); ?>>Enviado a Técnica</option>
                                <option value="pendiente" <?php echo e(request('estado') == 'pendiente' ? 'selected' : ''); ?>>Pendiente</option>
                                <option value="impreso" <?php echo e(request('estado') == 'impreso' ? 'selected' : ''); ?>>Impreso</option>
                            </select>
                        </div>
                        <div>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="border border-gray-200 px-2 py-2">
                            <div style="display:flex; gap:4px; align-items:center; justify-content:center;">
                                <a href="<?php echo e(route('tecnico.organizacion.edit', $entrada->id)); ?>"
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/tecnico/organizaciones_tecnico.blade.php ENDPATH**/ ?>